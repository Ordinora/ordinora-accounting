...
export default async function NewPayment() {
  ...
  const [bankAccounts, postingAccounts, tenantCurrencies, inventoryItems, inventoryLocations, mappingAccounts] = await Promise.all([
