...
export async function createSalesOrder(formData: FormData) {
  const { user, active } = await requireActiveTenantForMutation(); authorize(user.staffRole); const input = header.parse(Object.fromEntries(formData));
